...
$string['configmaxtime'] = 'Max time for session';
$string['pausetime'] = 'Pause Time';
$string['configpausetime'] = 'Pause time between two session';
...
$string['err2'] = 'The session cannot exceed';
$string['err3'] = 'The virtual classroom is already booked for this period';
$string['err4'] = 'A free time must be respected between two virtual classroom';
